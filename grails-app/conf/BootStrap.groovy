...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        roadDirection.each { name ->
            def item = new RoadDirection(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        islandType.each { name ->
            def item = new IslandType(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        horizontal.each { name ->
            def item = new Horizontal(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        intersection.each { name ->
            def item = new Intersection(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }

        String[] uTurn = ["ไม่ได้เกิดเหตุที่จุดยูเทิร์น", "จุดยูเทิร์น มีช่องลดความเร็ว", "จุดยูเทิร์น ไม่มีช่องลดความเร็ว"]
        uTurn.each { name ->
            def item = new UTurn(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        roadTypeSpecial.each { name ->
            def item = new RoadTypeSpecial(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }

        String[] roadHumidity = ["เปียก", "แห้ง"]
        roadHumidity.each { name ->
            def item = new RoadHumidity(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }

        String[] roadSurface = ["ดี", "สกปรก", "เป็นคลื่น/หลุม/บ่อ"]
        roadSurface.each { name ->
            def item = new RoadSurface(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }

        String[] weather = ["แจ่มใส", "ฝนตก", "มีควัน/ฝุ่น", "มีหมอก"]
        weather.each { name ->
            def item = new Weather(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }

        String[] light = ["มีแสงสว่างเพียงพอ", "ไม่มีแสงสว่างเพียงพอ", "ไม่ระบุ"]
        light.each { name ->
            def item = new Light(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        reason.each { name ->
            def item = new Reason(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        accidentType.each { name ->
            def item = new AccidentType(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        crashPattern.each { name ->
            def item = new CrashPattern(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        carType.each { name ->
            def item = new CarType(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }

        String[] gender = ["ชาย", "หญิง"]
        gender.each { name ->
            def item = new PersonGender(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        equipment.each { name ->
            def item = new PersonEquipment(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        drug.each { name ->
            def item = new PersonDrug(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        drivingLicense.each { name ->
            def item = new PersonDrivingLicense(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        personInjury.each { name ->
            def item = new PersonInjury(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        seatPosition.each { name ->
            def item = new SeatPosition(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }

        String[] passengerGender = ["ชาย", "หญิง"]
        passengerGender.each { name ->
            def item = new PassengerGender(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        passengerEquipment.each { name ->
            def item = new PassengerEquipment(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
        ...
        passengerInjury.each { name ->
            def item = new PassengerInjury(name: name, createdDate: new Date(), updatedDate: new Date())
            item.save()
        }
